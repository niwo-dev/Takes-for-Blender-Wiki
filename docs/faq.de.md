...
??? Frage „Was passiert mit meiner Animation, wenn ich die Ansichtsebenen wechsle?“
    ...
    Animation auf der Ziel-Ansichtsebene haben. Ist dies der Fall, wird die
    Kaskadenaktion automatisch angewendet.
...
??? Frage „Das Add-on wird nach der Installation nicht angezeigt.“
    Stellen Sie sicher, dass Sie die Installation direkt aus der `.zip`-Datei durchgeführt haben, ohne sie zu entpacken.
