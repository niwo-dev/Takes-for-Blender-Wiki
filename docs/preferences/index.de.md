...
| **Voreingestellter Automationsmodus** | Manuell | Wie Änderungen an Voreinstellungen behandelt werden (automatisch übernehmen, synchronisieren, manuell). |
...
| Einstellung | Standard | Beschreibung |
|---------|---------|-------------|
| **Syntax-Klammern** | Quadratisch `[]` | Stil der Token-Trennzeichen für Smart Output. |
| **Trennzeichen** | `sep1`=`_` | Bis zu 5 konfigurierbare Trennzeichen-Token. |

## Debug-Protokollierung

Wenn diese Option aktiviert ist, schreibt die Debug-Protokollierung in tägliche Protokolldateien mit detaillierter Themenfilterung:
