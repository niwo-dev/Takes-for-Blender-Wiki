...
| Panel | Purpose |
|-------|---------|
| [**Navigation Panel**](navigation_panel.md) | The primary control center — Take/VL switching, tree view, cascade icons, and batch render access. |
...
- **Context** — The Takes Tree and per-VL settings
