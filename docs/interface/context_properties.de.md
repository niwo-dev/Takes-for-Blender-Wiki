...
- **Aktuelle Aktion** — Die aufgelöste Kaskaden-Aktion für diese Ansichtsebene.
...
Überschreibungen werden von oben nach unten durch die Kaskadenhierarchie aufgelöst. Der erste nicht leere Wert hat Vorrang:

```
Global → Szenengruppe → Szene → VL-Gruppe → Ansichtsebene → VL-Version
```
