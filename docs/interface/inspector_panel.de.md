...
Objekte in der Beobachtungsliste haben einen von zwei Zuständen:

Verwaltet
:   Folgt dem Kaskadensystem. Die Aktion des Objekts wird automatisch durch die Kaskade der aktiven Ansichtsebene zugewiesen.

Fixiert
:   Ausgenommen von der Kaskadenverwaltung. Das Objekt behält seine eigene Aktion unabhängig von Wechseln der Ansichtsebene. Fixieren Sie ein Objekt, indem Sie auf das **Fixiersymbol** in seiner Zeile klicken.
...
| Spalte | Beschreibung |
|--------|-------------|
| **Fixieren** | Status „verwaltet/fixiert“ umschalten. |
