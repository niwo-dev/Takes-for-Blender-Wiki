...
Der Navigationsbereich ist die zentrale Schaltstelle für die Verwaltung Ihrer Takes-Hierarchie. Er enthält den Takes-Baum, Symbole für kaskadierende Überschreibungen und den Zugriff auf das Batch-Rendering.

## Steuerelemente in der Kopfzeile

In der Kopfzeile des Bereichs werden die Add-on-Version angezeigt und Schnellzugriffstasten bereitgestellt:
...
Jede Zeile einer Ansichtsebene zeigt Symbole für Kaskadenüberschreibungen an. Diese Symbole zeigen auf einen Blick, welche Eigenschaften auf dieser Ebene überschrieben werden:

- **Ghost** — Status „Rest State“
- **Tag** — Zugewiesenes Farb-Tag
- **Variant** — Status des aktiven Varianten-Schalters
- **Action** — Zuweisung einer Kaskadenaktion
- **Compositor** — Überschreibung des Knotenbaums
- **World** — Überschreibung von Welt/Umgebung
- **Kamera** — Kamerazuweisung
- **Ausgabe** — Ausgabe-Tag/Regel
- **Render** — Render-Voreinstellung

!!! Tipp „Überlauf der Kaskadensymbole“
...
|---------|-------------|
| **Tag-Farbe anzeigen** | Einrückungslinien der Baumstruktur nach Tag-Zuweisung einfärben. |
| **Linienbreite** | Dünne / Mittlere / Breite Einrückungslinien. |
| **Symbol-Sichtbarkeit** | Einzelne Kaskadensymbole ein- und ausschalten. |
