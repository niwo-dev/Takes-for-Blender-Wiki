...
!!! tip "Rest State"
    Das Ruhezustandssystem stellt sicher, dass Objekte in ihre Standardpose zurückkehren,
    wenn von einer animierten VL weggewechselt wird. Dies geschieht automatisch.
