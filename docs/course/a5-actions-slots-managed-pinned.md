...
## 1. What a switch does <span class="tks-min">5 min</span> { #1-what-a-switch-does }
...
## 2. Managed or pinned <span class="tks-min">4 min</span> { #2-managed-or-pinned }
...
## 3. Keeping one object's animation <span class="tks-min">4 min</span> { #3-keeping-one-objects-animation }
...
## 4. Why Autokey records nothing <span class="tks-min">4 min</span> { #4-why-autokey-records-nothing }
...
## 5. Duplicating an object <span class="tks-min">5 min</span> { #5-duplicating-an-object }
