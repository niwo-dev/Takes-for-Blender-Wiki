...
## 1. The quick way: the Swap List<span class="tks-min">4 min</span>
...
## 2. Product, Part, Pool, State<span class="tks-min">5 min</span>
...
## 3. Building three finishes<span class="tks-min">7 min</span>
...
## 4. Rendering every colourway<span class="tks-min">5 min</span>
...
## 5. When two looks collide<span class="tks-min">4 min</span>
