# B5.1 · Tag, filter, render

**Stage B · Build looks and shots** — B5 · Tags and Rules · **4 min** · video 53 of 80

The idea this module plants: **a label can do work for you**.
...
The lesson links to: [Tag & Filter Takes](../workflows/tag_and_filter.md) · [Tag Library](../features/tags.md)
