# C1.1 · Automatic render file names

**Stage C · Render and deliver** — C1 · Automatic file names · **5 min** · video 58 of 80
...
The lesson links to: [Smart Output](../features/smart_output.md)
