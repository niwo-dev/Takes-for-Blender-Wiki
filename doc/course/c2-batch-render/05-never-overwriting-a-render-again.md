# C2.5 · Never overwriting a render again

**Stage C · Ship it** — C2 · Batch Render · **6 min** · video 67 of 80

The idea this module plants: **one click renders everything**.
...
The lesson links to: [Versions](../features/batch_render.md#versions-sub-versions-notes)
